...
<p align="center">
  <img src="/partctl/img/gpt_tabla_mentes_helyreallitas_resized.png" alt="GPT partíciós tábla — mentés, helyreállítás, ellenőrzés (Partctl / sgdisk)" width="100%" />
</p>
...
> Megjegyzés: **MBR** (`msdos`) lemezen ezek a menük **nem** érhetők el (hibaüzenet: csak ). MBR ellenőrzéshez a Partctl külön menüpontot ad: **Verify MBR partition table** / **MBR tabla ellenorzes**.
...
| --- | --- |
| ![gpt_tabla_mentes_1](/partctl/img/gpt_tabla_mentes_1.jpg "GPT partíciós tábla mentés #1") | ![gpt_tabla_mentes_2](/partctl/img/gpt_tabla_mentes_2.jpg "GPT partíciós tábla mentés #2") |
...
| --- | --- | --- |
| ![gpt_tabla_helyreallitas_1](/partctl/img/gpt_tabla_helyreallitas_1.jpg "GPT partíciós tábla helyreállítása #1") | ![gpt_tabla_helyreallitas_2](/partctl/img/gpt_tabla_helyreallitas_2.jpg "GPT partíciós tábla helyreállítása #2") | ![gpt_tabla_helyreallitas_3](/partctl/img/gpt_tabla_helyreallitas_3.jpg "GPT partíciós tábla helyreállítása #3") |
...
| Megerősítés | Információ |
| --- | --- |
| ![gpt_tabla_ellenorzes_4](/partctl/img/gpt_tabla_ellenorzes_4.jpg "GPT partíciós tábla ellenőrzés #1") | ![gpt_tabla_ellenorzes_5](/partctl/img/gpt_tabla_ellenorzes_5.jpg "GPT partíciós tábla ellenőrzés #2") |
