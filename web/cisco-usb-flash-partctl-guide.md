...
| 4 | **Főmenü → `3`** → **Create partition** / **Particio letrehozasa** | **Kezdet:** **Enter** a javasolt **`2048s`** értékre (1 MiB-igazítás). **Vég:** **`100%`** — a Partctl mostantól a vég oldalon is **1 MiB**-os védőkeretet hagy és **2048-szektoros** boundary-ra igazít (lásd [`particio-igazitas-partctl-guide.md`](particio-igazitas-partctl-guide.md) §3), így a `sgdisk -v` is csendes lesz. |
