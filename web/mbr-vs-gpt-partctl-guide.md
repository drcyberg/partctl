...
- Az **MBR** séma a lemez **elején** tárolja a boot rekordot és a **partíciós bejegyzéseket** (klasszikusan **4 „slot”**: elsődleges partíciók + an egy **kiterjesztett** konténer, abban **logikai** partíciók).
