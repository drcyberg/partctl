...
| `sdc3` | 120 GiB | NTFS | Microsoft basic data (rendszer) | `PARTTYPE` **Microsoft basic data**; GUID **`EBD0A0A2-B9E5-4433-87C0-68B6B72699C7`**; példa csatolás: **`/media/llukacsi/Partctl1`** |
...
4. Szükség esetén oldj fel **csatolásokat**, ha a program kéri (például ha a **`sdc3`** még csatolva volt — a példa szerint pl. **`/media/llukacsi/Partctl1`**).
...
![](/img/particio_tabla_letrehozasa_1.jpg)
...
![](/img/particio_letrehozasa_1.jpg)
...
![](/img/particio_parameterek_1.jpg)
...
| Windows (`sdc3`) | **ntfs** | **`ntfs`**; ha csatolod: pl. **`/media/llukacsi/Partctl1`** |
...
### Partíció részletei
![](/img/particio_reszletei_1.jpg)

### GPT tábla ellenőrzése
![](/img/gpt_tabla_ellenorzese.jpg)
...
### Lemezkezelés
![](/img/lemez_kezeles_1.png)
![](/img/lemez_kezeles_2.png)
